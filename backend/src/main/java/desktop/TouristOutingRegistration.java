...
public class TouristOutingRegistration extends JInternalFrame {
	...
	protected void cmdTouristOutingActionPerformed(ActionEvent arg0) {
		...
		if (checkFormulario()) {
			...
			DtTouristOuting newTouristOuting = new DtTouristOuting(outingNameTO, maxNumTouristsTOint, departurePointTO,
					departureDateTOldt, dischargeDateTO, touristActivityName, null);
			...
			try {
				...
				// Success
				JOptionPane.showMessageDialog(this, "La salida turistica fue creada exitosamente.",
				...
				// Error message
				JOptionPane.showMessageDialog(this, e.getMessage(), "Alta de salida turistica",
	...
	private boolean checkFormulario() {
		...
		if (outingNameTO.isEmpty() || maxNumTouristsTO.isEmpty() || departurePointTO.isEmpty()
				|| departureDateTOldt == null || touristActivityName == null) {
		...
		try {
			...
			JOptionPane.showMessageDialog(this, "El campo «Maxima cantidad de turistas» debe ser un número.",
