...
/**
 * <p>Clase Java para listOutingInscription complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="listOutingInscription"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "listOutingInscription", propOrder = {
    "outingName"
})
public class ListOutingInscription {
