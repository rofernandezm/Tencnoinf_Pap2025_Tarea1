...
/**
 * <p>Clase Java para consultTouristOutingData complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="consultTouristOutingData"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "consultTouristOutingData", propOrder = {
    "outingName"
})
public class ConsultTouristOutingData {
