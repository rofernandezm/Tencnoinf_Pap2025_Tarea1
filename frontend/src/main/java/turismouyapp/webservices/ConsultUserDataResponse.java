...
/**
 * <p>Clase Java para consultUserDataResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="consultUserDataResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "consultUserDataResponse", propOrder = {
    "dtUser"
})
public class ConsultUserDataResponse {
