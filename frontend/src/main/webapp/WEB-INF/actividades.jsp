...
<head>
  ...
  <style>
    ...
    .card-grid .card-img-top { height: 150px; object-fit: cover; }
    .card-grid .card-body { display: flex; flex-direction: column; }
    .card-grid .btn { margin-top: auto; }
  </style>
</head>
      ...
      <div class="card shadow-sm border-0">
        <div class="card-body d-flex flex-column flex-md-row align-items-start align-items-md-center justify-content-between gap-3">
          <div>
            ...
            <p class="text-body-secondary mb-0">Publicá una nueva actividad para que aparezca en el listado.</p>
          </div>
          <!-- ahora navega a una página -->
          <a href="actividadForm.html" class="btn btn-outline-primary">
  ...
  <section class="bg-body-tertiary py-3">
    <div class="container">
      <form id="buscadorTop" class="d-flex gap-2" role="search">
        <input id="buscadorTopInput" class="form-control form-control-lg" type="search" placeholder="Buscar actividades..." aria-label="Buscar">
    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5 g-4">
      ...
      <div class="col">
        <div class="card h-100">
          <img src="Imagenes/turis.jpg" class="card-img-top" alt="Caminata por la Rambla">
          <div class="card-body">
      ...
      <div class="col">
        <div class="card h-100">
          <img src="Imagenes/turismo-peru-scaled.jpg" class="card-img-top" alt="City tour">
          <div class="card-body">
      ...
      <div class="col">
        <div class="card h-100">
          <img src="Imagenes/turismo_sostenible.avif" class="card-img-top" alt="Turismo sostenible">
          <div class="card-body">
