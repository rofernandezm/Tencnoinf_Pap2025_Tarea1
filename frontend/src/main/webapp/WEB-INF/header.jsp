    ...
    <nav class="navbar navbar-expand-sm navbar-dark bg-primary">
        <div class="container-fluid">
            <a class="navbar-brand" href="home.">TurismoUy</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul
                    class="navbar-nav d-flex flex-column flex-sm-row ms-sm-auto align-items-start align-items-sm-center gap-2 gap-sm-3">
                    <li class="nav-item">
