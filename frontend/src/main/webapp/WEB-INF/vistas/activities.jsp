				...
				<div class="row g-0">
					...
					<div class="col">
						<div class="card h-100">
							<img src="Imagenes/turis.jpg" class="card-img-top" alt="...">
							<div class="card-body">
							...
							<form id="formActividad" novalidate enctype="multipart/form-data">
								<div class="modal-body">
									...
									<div class="row g-3">
										...
										<div class="col-md-6">
											<label for="actProvider" class="form-label">Proveedor
												*</label> <input type="text" class="form-control" id="actProvider"
										...
										<div class="col-md-6">
											...
											<div class="input-group">
												<input type="number" min="1" step="1" class="form-control"
													id="actDurationHours" name="durationHours" required>
										...
										<div class="col-md-6">
											...
											<div class="input-group">
												<span class="input-group-text">UYU</span> <input
													type="number" min="0" step="1" class="form-control"
													id="actCost" name="cost" required>
