                ...
                <div class="col-12 col-lg-10 col-xl-9">
                    <div class="card shadow-sm">
                        <div class="card-body p-0">
                            ...
                            <form action="<%=ctx%>/modify-data-user" method="POST"
                                enctype="multipart/form-data">
                                <div class="row g-0">
                                    <!-- Columna izquierda: Foto de perfil -->
                                    <div class="col-md-4 photo-section">
                                        <img
                                            src="<%=ctx%>/profile_img/${sessionScope.logged_user.imagePath}"
                                        ...
                                        <div class="px-3">
                                            ...
                                            </label> <input class="form-control form-control-sm" type="file"
                                                id="new-profilephoto" name="new-profilephoto"
                                                accept="image/*"> <small
                                                class="text-muted d-block mt-1">JPG, PNG o GIF (máx.
                                                5MB)</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-8 data-section">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <label for="email-user" class="form-label">Correo
                                                    electrónico</label> <input type="email" class="form-control"
                                                    id="email-user" value="${sessionScope.logged_user.email}"
                                                    readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                <label for="name-user" class="form-label">Nombre</label> <input
                                                    type="text" class="form-control" id="name-user"
                                                    name="name-user" value="${sessionScope.logged_user.name}">
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                <label for="password-user" class="form-label"> Nueva
                                                    contraseña <small class="text-muted">(opcional)</small>
                                                </label> <input type="password" class="form-control"
                                                    id="password-user" name="password-user"
                                                    placeholder="Dejar vacío para no cambiar">
                                            </div>

                                            <div class="col-md-6 mb-3">
                                                <label for="passwordconf-user" class="form-label">Confirmar
                                                    contraseña</label> <input type="password" class="form-control"
                                                    id="passwordconf-user" name="passwordconf-user"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                <label for="birthdate-user" class="form-label">Fecha
                                        ...
                                        <!-- Botones -->
                                        <div
                                            class="d-grid gap-3 d-md-flex justify-content-md-center mt-4 mb-3">
                                            ...
                                            <button type="button" class="btn btn-secondary px-4"
                                                style="min-width: 180px;"
                                                onclick="window.location.href='<%=ctx%>/home'">
