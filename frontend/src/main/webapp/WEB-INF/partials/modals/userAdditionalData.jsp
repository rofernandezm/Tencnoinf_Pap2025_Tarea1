...
<c:if test="${not empty usuario}">
                            ...
                            <c:choose>
                                <c:when test="${not empty activitiesWithOutings}">
                                    <div class="accordion" id="accordionActivities">
                                        <c:forEach var="activityWithOutings" items="${activitiesWithOutings}" varStatus="actStatus">
                                            <div class="accordion-item">
                                                <h2 class="accordion-header" id="heading${actStatus.index}">
                                                    <button class="accordion-button ${actStatus.index != 0 ? 'collapsed' : ''}"
                                                        ...
                                                        <strong>${activityWithOutings.activity.activityName}</strong>
                                                    </button>
                                                </h2>
                                                    ...
                                                    <div class="accordion-body">
                                                        ...
                                                        <div class="mb-3 p-3 bg-light rounded">
                                                            <div class="d-flex justify-content-between align-items-start mb-3">
                                                                <h6 class="mb-0">
                                                                    <i class="bi bi-info-circle me-2"></i>Información de la Actividad
                                                                </h6>
                                                                <c:if test="${activityWithOutings.activity.status == 'CONFIRMED'}">
                                                                    <a href="${pageContext.request.contextPath}/activities?q=${activityWithOutings.activity.activityName}"
                                                                       class="btn btn-sm btn-primary"
                                                                       title="Ver información completa de la actividad">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <c:if test="${isOwnProfile}">
                                                                        <p class="mb-2">
                                                                            ...
                                                                            <c:choose>
                                                                                <c:when test="${activityWithOutings.activity.status == 'CONFIRMED'}">
                                                                                    <span class="badge bg-success">Confirmada</span>
                                                                                </c:when>
                                                                                <c:when test="${activityWithOutings.activity.status == 'ADDED'}">
                                                                                    <span class="badge bg-warning text-dark">Agregada</span>
                                                                                </c:when>
                                                                                <c:when test="${activityWithOutings.activity.status == 'REJECTED'}">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <p class="mb-2">
                                                                        <strong>Duración:</strong> ${activityWithOutings.activity.duration.toHours()} horas
                                                                    </p>
                                                                    <p class="mb-2">
                                                                        <strong>Costo por turista:</strong> $${activityWithOutings.activity.costTurist}
                                                                    </p>
                                                                    <p class="mb-2">
                                                                        <strong>Ciudad:</strong> ${activityWithOutings.activity.city}
                                                                    </p>
                                                                <p class="mb-0">
                                                        ...
                                                        <h6 class="border-top pt-3 mb-3">
                                                            <i class="bi bi-calendar-event me-2"></i>Salidas Turísticas
                                                        </h6>
                                                        <c:choose>
                                                            <c:when test="${not empty activityWithOutings.outings}">
                                                                <div class="table-responsive">
                                                                    <table class="table table-sm table-hover">
                                                                        ...
                                                                        <tbody>
                                                                            <c:forEach var="outing" items="${activityWithOutings.outings}">
                                                                                <tr>
 ...
 %>
                                                                                    ...
                                                                                    <td>
                                                                                        <span class="badge bg-info">
                                                                                            ${outing.maxNumTourists}
                                                                                        </span>
                                                                                    </td>
                                                                                    <td>
                                                                                        ${outing.dischargeDate}
                                                                                    </td>
                                                                                    <td>
                                                                                        <a href="${pageContext.request.contextPath}/outings?q=${activityWithOutings.activity.activityName}"
                                                                                           class="btn btn-sm btn-outline-primary"
                                                                                           title="Ver detalles de la salida">
                                                            ...
                                                            <c:otherwise>
                                                                <div class="alert alert-info">
                                                                    <i class="bi bi-info-circle me-2"></i>Esta actividad no tiene salidas turísticas registradas.
                                                                </div>
                                                            </c:otherwise>
                                                        </c:choose>
                                                    </div>
                                ...
                                <c:otherwise>
                                    <div class="alert alert-info text-center">
                                        ...
                                        Este proveedor no tiene actividades turísticas registradas.
                                    </div>
                                </c:otherwise>
                            </c:choose>
                        </c:if>
                            ...
                            <c:choose>
                                <c:when test="${not empty outingInscriptions}">
                                    <div class="accordion" id="accordionInscriptions">
                                        <c:forEach var="inscription" items="${outingInscriptions}" varStatus="insStatus">
                                            <div class="accordion-item">
                                                <h2 class="accordion-header" id="headingIns${insStatus.index}">
                                                    <button class="accordion-button ${insStatus.index != 0 ? 'collapsed' : ''}"
                                                        type="button" data-bs-toggle="collapse"
                                                        ...
                                                        <strong>${inscription.turistOuting.outingName}</strong>
                                                        <span class="mx-2 text-muted">—</span>
                                                        <span class="text-muted small">${inscription.turistOuting.activityName}</span>
                                                    </button>
                                                </h2>
                                                    ...
                                                    <div class="accordion-body">
                                                        ...
                                                        <div class="mb-3 p-3 bg-light rounded">
                                                            <div class="d-flex justify-content-between align-items-start mb-3">
                                                                ...
                                                                <div>
                                                                    <a href="${pageContext.request.contextPath}/outings?q=${inscription.turistOuting.activityName}"
                                                                       class="btn btn-sm btn-outline-primary me-2"
                                                                       title="Ver información completa de la salida">
                                                                        <i class="bi bi-calendar-event me-1"></i>Ver salida
                                                                    </a>
                                                                    <a href="${pageContext.request.contextPath}/activities?q=${inscription.turistOuting.activityName}"
                                                                       class="btn btn-sm btn-primary"
                                                                       title="Ver información completa de la actividad">
                                                                        <i class="bi bi-geo-alt me-1"></i>Ver actividad
                                                                    </a>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <p class="mb-2">
                                                                        <strong>Salida:</strong> ${inscription.turistOuting.outingName}
                                                                    </p>
                                                                    <p class="mb-2">
                                                                        <strong>Actividad:</strong> ${inscription.turistOuting.activityName}
                                                                    </p>
                                                                    <p class="mb-2">
 ...
 %>
                                                                    ...
                                                                    <p class="mb-0">
                                                                        <strong>Punto de salida:</strong> ${inscription.turistOuting.departurePoint}
                                                                    </p>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <p class="mb-2">
                                                                        <strong>Cupos máximos:</strong>
                                                                        <span class="badge bg-info">${inscription.turistOuting.maxNumTourists}</span>
                                                                    </p>
                                                                    <c:if test="${isOwnProfile}">
                                                                        <p class="mb-2">
                                                                        ...
                                                                        <p class="mb-2">
                                                                            <strong>Cantidad de turistas:</strong>
                                                                            <span class="badge bg-primary">${inscription.touristAmount}</span>
                                                                        </p>
                                                                        <p class="mb-0">
                                                                            <strong>Costo total:</strong>
                                                                            <span class="text-success fw-bold">$${inscription.totalCost}</span>
                                                                        </p>
                                                                    </c:if>
                                                                </div>
                                                            </div>
                                ...
                                <c:otherwise>
                                    <div class="alert alert-info text-center">
                                        <i class="bi bi-info-circle me-2"></i>
                                        Este turista no tiene inscripciones a salidas turísticas.
                                    </div>
                                </c:otherwise>
                            </c:choose>
                        </c:if>
